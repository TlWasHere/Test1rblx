...
local CORRECT_KEY = "YOUR_KEY_HERE"          -- Change this to your actual key
local KEY_LINK = "https://link-hub.net/5694943/YGA14xLjt5gU"
...
Title.Text = "🔐  Server Hopper — Key System"  -- EDIT: your hub name
...
NoteLabel.Text = "Get your key from the link above"  -- EDIT: your credit/note
...
-- Get Key: copies link to clipboard
...
-- Submit: check key then run your script
